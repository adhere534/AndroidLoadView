...
import com.adhere.view.swipe.SwipeRefreshLayout;
import com.example.adhere.loadview.R;


public class CommRecyclerView extends FrameLayout {
    ...
    public CommRecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView() {
        ...
        //生成主View
        View v = LayoutInflater.from(getContext()).inflate(R.layout.layout_recyclerview, this);
    ...
    private static class EasyDataObserver extends AdapterDataObserver {
        ...
        public EasyDataObserver(CommRecyclerView recyclerView,boolean hasProgress) {
